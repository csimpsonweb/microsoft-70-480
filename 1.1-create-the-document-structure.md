...
Os elementos \<figcapiton> e \<figure>, novos no Html5, prover os elementos semânticos necessários para incluir gráficos e figuras em uma página. Essas figuras e gráficos fornecem uma representação visual de informações no conteúdo e referencias através do texto.
