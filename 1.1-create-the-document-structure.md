...
O metadados são um conjunto de informações da  página e do seu conteúdo. São definidos usando a tag \<meta>. Essas informações são de uso do navegador e ficam transparentes para  o usuário. Todos o Metadados são declarados na tag \<head>
